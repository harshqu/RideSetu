# RideSetu — Real Razorpay Sandbox Integration & Pilot Launch Rollback Guide

This document provides independent rollback instructions for the Real Razorpay Sandbox Integration, Webhooks & End-to-End Pilot Launch milestone.
...
# Revert to final PWA UX milestone
...
| `ui/final-pwa-ux` | Real Device UX Polish, PWA Enhancement & Production Readiness | Preserved |
| `integration/razorpay-sandbox-pilot` | Real Razorpay Sandbox Integration, Webhooks & Pilot Launch | Active Working Branch |
