...
import { ShieldCheck, Mail, Phone, Lock, User, ArrowRight, ArrowLeft, RefreshCw, CheckCircle2, AlertCircle } from 'lucide-react';
...
export default function CustomerRegisterPage() {
  ...
  const handleVerifyAndRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStep(4);
      setSuccessMsg('Account verified and created successfully! Redirecting to your dashboard...');
      setTimeout(() => {
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 py-12">
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full border border-slate-200 overflow-hidden">
        ...
        <div className="bg-slate-900 text-white p-6 text-center relative">
          ...
          <p className="text-xs text-slate-400 mt-1">Rider Account Registration</p>
        </div>
        ...
        <div className="p-6 md:p-8">
          ...
          {step === 1 && (
            <form onSubmit={handleStep1Submit} className="space-y-4">
              <h2 className="text-xl font-bold text-slate-900 mb-2">Create Your Rider Account</h2>
              <p className="text-sm text-slate-600 mb-4">Enter your basic details to get started.</p>
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-700 uppercase mb-1">Mobile Number (India)</label>
                <div className="relative">
          ...
          {step === 2 && (
            <div className="space-y-6">
              <div>
                ...
                <h2 className="text-xl font-bold text-slate-900 mb-1">Choose Verification Method</h2>
                <p className="text-sm text-slate-600">Select how you would like to receive your 6-digit OTP code.</p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-bold text-slate-900 text-base">Verify with Email</div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="font-bold text-slate-900 text-base">Verify with Mobile</div>
