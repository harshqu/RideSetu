    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="text-center space-y-3">
          ...
          <p className="text-xs text-slate-500 font-bold animate-pulse">Redirecting to your dashboard...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-md w-full bg-white rounded-3xl border border-slate-200 p-8 shadow-xl space-y-6">
        <div className="text-center space-y-2">
          <Link href="/" className="inline-flex items-center gap-2 group">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-[#FF6B00] to-amber-500 flex items-center justify-center text-white shadow-md shadow-[#FF6B00]/30">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs font-semibold">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 px-4 rounded-2xl bg-gradient-to-r from-[#FF6B00] to-amber-500 hover:from-amber-600 hover:to-[#FF6B00] text-white font-black text-xs shadow-md shadow-[#FF6B00]/20 flex items-center justify-center gap-2 transition-all disabled:opacity-50 min-h-[44px]"
          >
        ...
        <div className="border-t border-slate-100 pt-4 text-center text-xs text-slate-500 space-y-2">
          <div>
            ...
            <Link href="/register/customer" className="text-[#FF6B00] font-bold hover:underline">
